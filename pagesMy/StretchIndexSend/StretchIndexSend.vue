	...
	<view class="StretchIndexSend" style="position: absolute;width: 100%;min-height: 100%;">
		<view class="StretchIndexSend-padding" v-if="picshow">
		          ...
		          <view class="StretchIndexSend-content flex justify-between align-center border-bottom">
		              ...
		              <view class="StretchIndexSend-input">
		                <input  type="digit" placeholder="请输入商品原价" style="flex:1;font-size:16px;font-weight:400;text-align:right" v-model="original_price">
		              </view>
		          </view>
		          ...
		          <view class="StretchIndexSend-content flex justify-between align-center border-bottom">
		              ...
		              <view class="StretchIndexSend-input">
		                <input  type="digit" placeholder="请输入商品现价" style="flex:1;font-size:16px;font-weight:400;text-align:right" v-model="current_price">
		              </view>
		          </view>
		          ...
		          <view class="StretchIndexSend-content flex justify-between align-center border-bottom">
		              ...
		              <view class="StretchIndexSend-input">
		                <input  type="number" placeholder="请输入客服电话" style="flex:1;font-size:16px;font-weight:400;text-align:right" v-model.trim="mobile">
		              </view>
		          </view>
				  ...
				  <!-- 图片和描述 -->
					...
					<view>
					  ...
					  <view class="content" style="margin-bottom: 10px;">
					  	<button @tap="chooseImage()" style="margin-bottom: 20px;">选择商品主图（1张）</button>
...
<style>
	@import url("./StretchIndexSend.css");
	.image {
		width: 100px;
		height: 100px;
	}
