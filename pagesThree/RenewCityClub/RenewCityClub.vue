	  ...
	  <view class="listCon scroll" ref="list" style="overflow: auto;height: calc(100% - 88px);top:88px" v-show="isFinish">
	      ...
	      <view class="new_user_list">
	        <view class="bnew2 flex justify-start lii" v-for="(item,index) in list" :key="index">
	          <view class="re" style="width: 50px;height: 50px;border-radius: 100%;margin-right: 10px;">
				  <image :src="item.avatar?item.avatar:'https://web.detion.com/static/img/user_icon.png'" lazy-load="true" class="imga" mode="aspectFill" style="border-radius: 100%;"></image>
